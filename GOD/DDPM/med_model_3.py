...
class MyUNet(nn.Module):
    def __init__(self, n_steps=1000, time_emb_dim=100):
        ...
        self.b1 = nn.Sequential(
            MyBlock((1, 512, 512), 1, 10),
            MyBlock((10, 512, 512), 10, 10),
            MyBlock((10, 512, 512), 10, 10),
        )
        ...
        self.b2 = nn.Sequential(
            MyBlock((10, 256, 256), 10, 20),
            MyBlock((20, 256, 256), 20, 20),
            MyBlock((20, 256, 256), 20, 20),
        )
        ...
        self.b3 = nn.Sequential(
            MyBlock((20, 128, 128), 20, 40),
            MyBlock((40, 128, 128), 40, 40),
            MyBlock((40, 128, 128), 40, 40),
        )
        ...
        self.up1 = nn.Sequential(
            ...
            nn.SiLU(),
            nn.ConvTranspose2d(40, 40, 1, 1),
        )

        self.te4 = self._make_te(time_emb_dim, 80)
        self.b4 = nn.Sequential(
            MyBlock((80, 128, 128), 80, 40),
        ...
        self.b_out = nn.Sequential(
            MyBlock((20, 512, 512), 20, 10),
            MyBlock((10, 512, 512), 10, 10),
            MyBlock((10, 512, 512), 10, 10, normalize=False),
        )
