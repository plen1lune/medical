...
def save_individual_images(images, title="", save_path=""):
...
def main():
    ...
    # Model store path
    store_path = f'./weights/lung_train_120_class_{args["class"]}.pt'
    ...
    if args["class"] == 0:
        train_dataset = datasets.ImageFolder(root=image_path + "l",
                                             transform=transform)
    elif args["class"] == 1:
        train_dataset = datasets.ImageFolder(root=image_path + "m",
                                             transform=transform)
    else:
        train_dataset = datasets.ImageFolder(root=image_path + "s",
                                             transform=transform)
    ...
    save_individual_images(generated, "Final result", f'./lung_result/{args["class"]}')
