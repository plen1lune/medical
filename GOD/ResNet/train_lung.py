...
data_root = "/u/hvg7cb/UVA/gan"
image_path = data_root + "/imageadd3/"  # data set path
...
for epoch in range(100):
    ...
    with torch.no_grad():
        ...
        if val_accurate > best_acc and val_accurate > 0.85:
            ...
            json_path = os.path.join("./cl/", "lung_%.3f.json" % val_accurate)
            best_acc = val_accurate
            save_path = './path/lung_acc%.3f.pth' % val_accurate
