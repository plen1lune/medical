...
# 官方提供载入预训练模型的方法
model_weight_path = "/u/hvg7cb/UVA/gan/path/lung_acc0.928.pth"  # 权重路径
...
with torch.no_grad():
    ...
    if val_accurate > best_acc:
        ...
        # f.truncate()
        json_context = {}
        json_path = os.path.join("/u/hvg7cb/UVA/gan/cl/lung", "valid18_1_acc0.949_%.3f.json" % val_accurate)
