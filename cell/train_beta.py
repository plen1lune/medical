...
for epoch in range(100):
    ...
    with torch.no_grad():
        ...
        if val_accurate > best_acc and val_accurate > 0.85:
            ...
            json_path = os.path.join("./cl3/vit", "ViT18_respre_disl_3m0.5_%.3f.json" % val_accurate)
            best_acc = val_accurate
            save_path = './path3/vit/ViT18_respre_disl_3m0.5_acc%.3f.pth' % val_accurate
            model_path = './model3/vit/ViT18_respre_disl_3m0.5_acc%.3f.pth' % val_accurate
