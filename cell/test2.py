...
with torch.no_grad():
    ...
    pic_list = ["/mnt/nas/llc/acc80/image3_b_add3/test/medium/4-13_010.jpeg",
                "/mnt/nas/llc/acc80/image3_b_add3/test/medium/4_30_078.jpeg",
                "/mnt/nas/llc/acc80/image3_b_add3/test/medium/4_30_081.jpeg",
                "/mnt/nas/llc/acc80/image3_b_add3/test/medium/6_79_012.jpeg",
                "/mnt/nas/llc/acc80/image3_b_add3/test/medium/6_71_162.jpeg",
                "/mnt/nas/llc/acc80/image3_b_add3/test/medium/7_29_066.jpeg",
                ]

    """如果测试集的准确度比历史最佳还高，那么更新json文件，保存权重"""
    if val_accurate > best_acc:
        json_context = {}
        json_path = os.path.join("/mnt/nas/llc/acc80/result/test_moredata",
                                 "ViT_adam_resnet_pretrainedv3_bs16_depth10_clstoken_0.960_%.3f.json" % val_accurate)
        ...
        for step2, val_data in enumerate(validate_loader, start=0):
            ...
            for i in range(0, len(val_images.to(device))):
                ...
                val_sample_fname, _ = validate_loader.dataset.samples[step2 * batch_size + i]
                """if val_sample_fname == "/mnt/nas/llc/acc80/image3_b_add3/test/light/6_65_094.jpeg":#in pic_list: 
