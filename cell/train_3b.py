...
# 官方提供载入预训练模型的方法
model_weight_path = "./weight/resnet18.pth"  # 1权重路径:预训练权重 512 结果：887
...
for epoch in range(100):
    ...
    with torch.no_grad():
        ...
        if val_accurate > best_acc and val_accurate > 0.85:
            ...
            json_path = os.path.join("./cl3/b", "clasify18_new1_color_crop_%.3f.json" % val_accurate)
            best_acc = val_accurate
            save_path = './path/b/resNet18_new1_color_crop_acc%.3f.pth' % val_accurate
