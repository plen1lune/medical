...
train_dataset = datasets.ImageFolder(root=image_path + "test",
...
net = resnet18()  # 一开始不能设置全连接层的输出种类为自己想要的，必须先将模型参数载入，再修改全连接层
...
# 官方提供载入预训练模型的方法
model_weight_path = "/mnt/nas/llc/acc80/path3/b/resNet18_new_color_crop_acc0.885.pth"  # 权重路径
...
with torch.no_grad():
    ...
    if val_accurate > best_acc:
        ...
        # f.truncate()
        json_context = {}
        json_path = os.path.join("/mnt/nas/llc/acc80/cl3/raw", "valid18_1_acc0.949_%.3f.json" % val_accurate)
