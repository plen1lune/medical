...
data_root = "/home/llc/acc80"
image_path = data_root + "/images3/"  # data set path
...
# 官方提供载入预训练模型的方法
# model_weight_path = "./resnet34-pre.pth"  # 1权重路径:预训练权重 512 结果：887
...
model_weight_path = "./resnet34-pre.pth"  # 5，权重路径:预训练权重 512，0.2
...
for epoch in range(100):
    ...
    decay = 1
    if epoch > 5 and epoch % 10 == 0 and acc_val > 0.85:
    ...
    with torch.no_grad():
        ...
        if val_accurate > best_acc:
            ...
            # f.truncate()
            json_context = {}
            json_path = os.path.join("/home/llc/acc80/cl3/raw", "clasify34_7_%.3f.json" % val_accurate)
            best_acc = val_accurate
            save_path = './path3/raw/resNet34_7_acc%.3f.pth' % val_accurate
            model_path = './model3/raw/resNet34_7_acc%.3f.pth' % val_accurate
