...
# 官方提供载入预训练模型的方法
model_weight_path = "/home/xjl/llc/ybr/path/resnet34/315resnet34_15_acc0.946.pth"  # 1权重路径:预训练权重 512 结果：887
...
with torch.no_grad():
    ...
    if val_accurate > best_acc and val_accurate > 0.85:
        ...
        json_path = os.path.join("./result/json", "resnet34_trainb_testub_acc%.3f.json" % val_accurate)
        best_acc = val_accurate
