...
parser.add_argument('--exp', type=str,
                    default='ACDC/my_net', help='experiment_name')
parser.add_argument('--model', type=str,
                    default='unet', help='model_name')
parser.add_argument('--max_iterations', type=int,
                    default=30000, help='maximum epoch number to train')
parser.add_argument('--batch_size', type=int, default=8,  # 24
...
# label and unlabel
parser.add_argument('--labeled_bs', type=int, default=4,  # 12
...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            #       (outputs_soft1[args.labeled_bs:] - ema_output_soft) ** 2)
            # if iter_num < 1000:
            #    consistency_loss = 0.0
            # else:
            ...
            consistency_loss2 = torch.mean(
                (outputs_soft2[args.labeled_bs:] - ema_output_soft) ** 2)
            ...
            model1_loss = loss1 + consistency_weight * (pseudo_supervision1+consistency_loss1)/2
            model2_loss = loss2 + consistency_weight * (pseudo_supervision2+consistency_loss2)/2
