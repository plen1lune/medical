...
parser.add_argument('--exp', type=str,
                    default='ACDC/my_net2', help='experiment_name')
...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            model1_loss = loss1 + consistency_weight * (pseudo_supervision1+consistency_loss1)
            model2_loss = loss2 + consistency_weight * (pseudo_supervision2+consistency_loss2)
